                    ...
                    <div class="dropdown-menu">
                        <div class="dropdown-inner">
                            <ul class="list-unstyled">
                                ...
                                <li><a href="/gotoRegister">注册</a></li>
            ...
            <div class="col-md-6">
                <div class="box wrap-vid">
                    ...
                    <p class="more">Aenean feugiat in ante et blandit. Vestibulum posuere molestie risus, ac interdum
                        ...
                        accumsan.Aenean feugiat in ante et blandit. Vestibulum posuere molestie risus, ac interdum magna
                        porta non.ac interdum magna porta non. Pellentesque rutrum fringilla elementum. Curabitur
                        tincidunt porta lorem vitae accumsan</p>
                </div>
                <div class="box">
                    ...
                    <div class="box-content">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="more">Aenean feugiat in ante et blandit. Vestibulum posuere molestie risus, ac
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <span><i class="fa fa-heart"></i> 1,200 / <i class="fa fa-calendar"></i> 25/3/2015 / <i
                                        class="fa fa-comment-o"> / </i> 10 <i class="fa fa-eye"></i> 945</span>
                                <span class="rating">
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
										<i class="fa fa-star"></i>
                                ...
                                <p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever
                                    known. High on the rapids, it struck their tiny raft! And plunged them down a
                            ...
                            <div class="col-md-6">
                                ...
                                <p>There once was a story about a man who could turn invisible. I thought it was only a
                                    story… until it happened to me. Ok, so here’s how it works: there’s this stuff
                                    called...</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                ...
                <div class="widget wid-new-post">
                    ...
                    <div class="content">
                        ...
                        <p>Title should not overflow the content area A few things to check for: Non-breaking text in
                            the...</p>
                        <h6>Lorem Ipsum is simply dummy</h6>
            ...
            <div class="col-md-3">
                            ...
                            <form action="" role="form">
                                <div class="">
                                    <div class="input-group date form_date" data-date="" data-date-format="dd MM yyyy"
                                         data-link-field="dtp_input2" data-link-format="yyyy-mm-dd"></div>
                ...
                <div class="widget wid-tweet">
                    ...
                    <div class="content">
                        ...
                        <p>Marshall, Will, and Holly on a routine expedition, met the greatest earthquake ever known.
                            High on the rapids, it struck their tiny raft...</p>
                    </div>
                </div>
