			...
			<div class="row">
				...
				<#list movies as movie>
					<div class="box">
						...
						<div class="info">
							<h5>作者：<a href="#">${movie.author}</a></h5>
							<span><i class="fa fa-calendar"></i>上映时间：${movie.time?date}</span>
							<span><i class="fa fa-comment"></i>评论数：${movie.comments}</span>
							<span><i class="fa fa-heart"></i>点赞数：${movie.support}</span>
						...
						<div class="wrap-vid">
							...
							<p>${movie.description}<a href="#">MORE...</a></p>
						</div>
					</div>
					<hr class="line">
				</#list>
